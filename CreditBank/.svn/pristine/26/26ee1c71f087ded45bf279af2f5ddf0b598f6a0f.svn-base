...
- (void)checkNetworkState
{
    ...
    if (self.currentController) {
         NavigationController *navController  = (NavigationController *)self.currentController.selectedViewController;
    ...
    if ([NetWorkTools isEnableWIFI]) {
        ...
        [MBProgressHUD showNetWorkError:@"网络连接失败" toView:[[UIApplication sharedApplication].windows lastObject]];
    }
}
